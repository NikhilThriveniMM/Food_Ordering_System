...
const HeadComp = () => {
    ...
    <div className="headder">
        <div id="logo">
            <img id="LogoImage" src="https://img.freepik.com/free-vector/detailed-chef-logo-template_23-2148987940.jpg?w=740&t=st=1709044139~exp=1709044739~hmac=c65768523507ebc97c330888e814b1a6584e3968c557a9964d714b4be5138195"></img>
        </div>
        <div className="navItems">
            <ul>
                    <from>
                        <label for="search"></label>
                        <input type="text" placeholder="search restorents or foods you like">
                        </input>
                ...
                <li><a href="#" ><img id="cart" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWOyhDd92k8TD7OfVPoyNi1eip08GcV6gC7w&usqp=CAU"></img></a></li>
            </ul>
        </div>
    </div>
    )
...
const BodyComp = () => {
    return (
        <div className="cards">
          {
            resList.map((r)=>(
                <Rescard key={r.data.id} resData={r}/>
            ))
          }
...
const Rescard = (props) => {
    // {console.log(props);}
    // const {resName,cusine,address,rating} = props
    const {resData} = props;
    // console.log(resData);
    const {cloudinaryImageId,name,avgRating,cuisines,costForTwo} = resData.data;
   return (
    <div className="card">
       
            <img src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+cloudinaryImageId} className="resImage"></img>
        
        <h2>{name}</h2>
        <p>{avgRating}/5 rateing</p>
        <p>{cuisines.join(", ")}</p>
        {/* <p>{}Srats</p> */}
        <p>Rs. {costForTwo/100} FOR TWO</p>
        {/* <button type="submit" className="btn">Quick View</button> */}
    </div>
   )
}
